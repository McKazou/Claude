...
**Pourquoi** : une base de connaissance vouée à être générique et réutilisable (voir `partager-skill-equipe-git.md`) ne doit pas devenir, même involontairement, un vecteur de fuite d'informations personnelles.
...
→ Skill : `Skills/respecter-vie-privee/SKILL.md`

---
Tags : #personnel #confidentialite #utilisateur
