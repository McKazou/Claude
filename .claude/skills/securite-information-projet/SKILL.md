---
name: securite-information-projet
description: Applique un socle de règles de sécurité de l'information par défaut pendant le développement d'un projet logiciel (secrets, validation des entrées, moindre privilège, journalisation) — pas seulement lors d'une revue finale. À utiliser dès qu'un changement touche des secrets/identifiants, une entrée utilisateur ou externe, l'authentification, ou des données sensibles.
---
...
Source : `Fiches/regles-securite-information-projet.md`
